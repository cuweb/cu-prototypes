...
export const QuoteSymbol = ({ colour, shape }: QuoteSymbolProps) => {
  const blackDesign = colour ? styles.black : styles.red

  return (
    <>
      {!shape ? (
        <>
          <div className={`${styles.bar} ${blackDesign}`} />
        </>
      ) : (
        <>
          <div className={`${styles.symbol}`}>
            <svg
              className={`${blackDesign}`}
              fill="#000000"
              version="1.1"
              id="Capa_1"
