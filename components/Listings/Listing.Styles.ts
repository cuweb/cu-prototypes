...
export const figureStyles = {
  figure: `relative max-w-[40%] rounded-md overflow-hidden shadow-md`,
}
...
export const eventStyles = {
  ...
  dateBoxMonth: `text-xs @lg:lg:text-xl font-bold uppercase text-cu-red group-hover:text-white`,
  dateBoxDay: `text-2xl @lg:lg:text-5xl font-bold uppercase text-cu-black-800 group-hover:text-white`,
}
