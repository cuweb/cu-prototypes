export const styles = {
  ...
  contentWrapper:
    'flex flex-col gap-4 md:gap-6 justify-center flex-[0_0_100%] md:max-w-3xl md:flex-1',
  header:
    'text-2xl not-italic font-semibold md:leading-10 sm:text-3xl md:text-4xl',
  headerOne: 'text-3xl lg:text-5xl lg:leading-[3.5rem]',
  paragraph:
    'text-lg font-light italic text-cu-black-600 md:text-2xl md:leading-9 mb-2',
