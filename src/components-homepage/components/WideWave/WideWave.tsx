...
export default function WideWave({
  ...
  return (
    <section
      className={`cu-widewaves ${waveClass} ${waveBgColor} ${innerPadding} bg-[length:100.5%] bg-no-repeat cu-browsers-edge not-contained text-white pt-16 sm:pt-24 md:pt-36 lg:pt-44 xl:pt-48 pb-8 md:pb-20`}
      style={redWave}
    >
