...
export const TextMediaAside = ({
  ...
  const imageBorder =
    border && borderColor
      ? `cu-textmedia-img-border-${border} cu-textmedia-img-border-${borderColor}`
      : ''

  return (
    <div className={`cu-textmedia-aside flex-1 ${marginAuto} ${imageBorder}`}>
      {children}
    </div>
  )
}
